...
public class FetchBunny extends SequentialCommandGroup {
  ...
  public FetchBunny(SwerveDrivetrain drivetrain, Grabber grabber) {
    ...
    pathEvents.put("grabber-up",
        new ParallelCommandGroup(grabber.setTargetArmAngleCommand(ArmPosition.UP), grabber.stopFlywheelsCommand()));
    pathEvents.put("grabber-down", new SequentialCommandGroup(grabber.setTargetArmAngleCommand(ArmPosition.MIDDLE)));
