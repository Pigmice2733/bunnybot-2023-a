...
public class Turret extends SubsystemBase {
    ...
    public Turret() {
        rotationMotor = new CANSparkMax(CANConfig.ROTATE_TURRET,
        ...
        rotationController = new ProfiledPIDController(
                TurretConfig.ROTATION_P, TurretConfig.ROTATION_I,
                TurretConfig.ROTATION_D,
                new Constraints(TurretConfig.MAX_VELOCITY,
                        TurretConfig.MAX_ACCELERATION));

        ShuffleboardHelper
                .addOutput("Current Rotation", Constants.TURRET_TAB,
                        () -> getCurrentRotation())
                .asDial(-180, 180);

        ShuffleboardHelper
                .addOutput("Target Rotation", Constants.TURRET_TAB,
                        () -> targetRotation)
                .asDial(-180, 180);
    ...
    private void updateClosedLoopControl() {
        double calculatedOutput = rotationController.calculate(
                getCurrentRotation(),
                targetRotation);
    ...
    public void outputToMotor(double percentOutput) {
        ...
        // TODO: assumes (+ output) => (+ rotation). Verify this in later
        // testing.
    ...
    public double getCurrentRotation() {
        ...
        // TODO: once design is finalized, figure out the gear ratio and actual
        // sensor
    ...
    /**
     * Sets the max velocity and acceleration of the turret as a Constraints
     * object.
     */
    ...
    public boolean hasTarget() {
        return vision.getCurrentTarget() != null
                && getTurretVelocity() < TurretConfig.MAX_SHOOT_VELO;
    }
}
