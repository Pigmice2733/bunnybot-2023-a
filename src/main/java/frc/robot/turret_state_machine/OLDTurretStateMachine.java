...
// public class OLDTurretStateMachine {

// private Hashtable<TurretStates, TurretState> states = new
// Hashtable<TurretStates, TurretState>();
...
// public OLDTurretStateMachine(Turret turret, Vision vision, DoubleSupplier
// manualRotationSpeed) {
...
// /**
// * Periodically updates the state machine, including the {@code execute}
// method
...
// // If the manual control trigger is pressed, switch to the manual control
// state
...
// targetInRange = Math.abs(target.getYaw()) <
// TurretConfig.TARGET_YAW_TOLERENCE;
// }
...
// new Constraints(TurretConfig.WANDER_VELOCITY,
// TurretConfig.WANDER_ACCELERATION));
